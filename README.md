...
![Banner](assests/Portfolio_Banner.png) 
...
| 🎚️ **Equalizer App Landing page** | A clean landing page showcasing the Equalizer app and its key features | [Live Demo](https://mohammed-004del.github.io/mohamed-webdev-Equalizer_App/) |
| 🖼️ **Photo Editor project** | A simple photo editor interface with basic effects and interactive UI elements | [Live Demo](https://mohammed-004del.github.io/mohamed-webdev-Photo_Editor/) |
| 🗂️ **CRUD** | A CRUD project for creating, updating, deleting, and displaying data efficiently | [Live Demo](https://mohammed-004del.github.io/mohamed-webdev-CRUD_Project/) |
| 📊 **Dashboard** | Interactive charts and data visualization | [Live Demo](https://mohammed-004del.github.io/mohamed-webdev-Dashboard/) |
...
![Canvas API](https://img.shields.io/badge/-Canvas%20API-FF9E64?logo=canvas&logoColor=white&style=for-the-badge)  
...
- 🔗 [Equalizer App Landing page Demo](https://mohammed-004del.github.io/mohamed-webdev-Equalizer_App/)
- 🔗 [Photo Editor project Demo](https://mohammed-004del.github.io/mohamed-webdev-Photo_Editor/)
- 🔗 [CRUD Demo](https://mohammed-004del.github.io/mohamed-webdev-CRUD_Project/)
- 🔗 [Dashboard Demo](https://mohammed-004del.github.io/mohamed-webdev-Dashboard/)
